...
parser.add_argument('--data-path', type=str, default='/data/xiehong/SeqCo/data/cnn_dm-bin')
parser.add_argument('--raw-valid', type=str, default=None)
parser.add_argument('--raw-test', type=str, default='/data/xiehong/SeqCo/data/cnn_dm/test')
parser.add_argument('--input-file', type=str, default=None)
parser.add_argument('--output-dir', type=str, default='/data/xiehong/SeqCo/test/')
parser.add_argument('--model-dir', type=str, default='/data/xiehong/SeqCo/data/cnn_dm/')
...
for split in ['test', 'validation']:
    if split == 'test':
        source_file = '.'.join([args.raw_test, 'source']) if args.input_file is None else args.input_file
        print(source_file)
    elif args.raw_valid is None:
        continue
    else:
        source_file = '.'.join([args.raw_valid, 'source'])
