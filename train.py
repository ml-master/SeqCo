...
def main(args, init_distributed=False):
    ...
    if hasattr(args, 'init_from_pretrained_doc_model') and args.init_from_pretrained_doc_model:
        import os
        if not os.path.exists(os.path.join(args.save_dir, "checkpoint_last.pt")):
